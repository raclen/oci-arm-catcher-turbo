...
<img width="549" height="1172" alt="0d08b3c9711439e00ebc3664c8b83908" src="https://github.com/user-attachments/assets/316040fb-1a40-472e-b92a-2a94183c3be9" />
...
- **仅供学习研究**：本项目仅供学习 OCI CLI、自动化脚本及 Linux 服务部署技术使用，请勿用于任何商业用途或牟利行为。
- **违反条款风险自负**：甲骨文 Cloud Always Free 资源（含 `VM.Standard.A1.Flex`）长期处于供不应求状态，高频轮询、抢机等行为可能与甲骨文云的使用政策不完全一致。因使用本脚本造成的任何账户限制、暂停或封禁，均由使用者自行承担。
- **资源与费用风险**：本项目虽内置"抢到即止"与致命错误熔断，但仍无法保证在所有极端情况下绝不产生计费。使用前请自行确认租户的 Always Free 额度、配额与预算，设置好账单告警并承担相应责任。
- **无任何明示或暗示担保**：本项目按"原样"提供，作者不对脚本的稳定性、可用性、安全性及其结果作任何担保。
- **接受条款即使用**：克隆、下载、运行或修改本项目，即视为你已阅读并同意以上声明。
